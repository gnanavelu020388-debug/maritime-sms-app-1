...
import { getEffectiveDemoSmsDocs, getDemoTenant, getDemoCustomTabs, saveDemoCustomTabs, demoUpdateSmsDocContent, demoCreateSmsDoc, demoResubmitSmsDoc, demoDeleteSmsDoc, getEffectiveDemoVessels } from '../lib/demoData';
...
export function SmsLibrarySplitView({ tenantId, vesselId, readOnly = true, enableProfileSelector = false, rankPermissions = null, authorName = null, authorRole = null, authorOrigin = null }: SmsLibrarySplitViewProps) {
  ...
  const loadTabCounts = useCallback(async () => {
    ...
    let allDocs: SmsDocRow[] = getEffectiveDemoSmsDocs(tenantId, undefined, effectiveProfileId);
